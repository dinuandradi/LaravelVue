        ...
        <v-parallax src="https://cdn.hipwallpaper.com/i/82/58/VhbYJl.jpg" max-height="1000" height='100%'>
            ...
            >
                <v-container>
                    ...
                    >
                    <v-img height="100%" 
                    src="https://www.goldenglobes.com/sites/default/files/styles/portrait_medium/public/gallery_images/17-tomcruiseag.jpg?itok=qNj0cQGV&c=c9a73b7bdf609d72214d226ab9ea015e"></v-img>
                     </v-avatar>
                    <!--/v-col-->
                        <!--v-col class="py-0">
...
<script>
    ...
    mounted() {
        this.getworkerProfile3();
    },
    methods:{
        getworkerProfile3() {
            const vm = this;
            axios.get('http://localhost:8000/api/getworkerProfile3')
